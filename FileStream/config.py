...
class Telegram:
    ...
    BOT_TOKEN = str(env.get("BOT_TOKEN", '6590978998:AAFxHZcqaRmDUeZ64mk9pCYy-n08bYVyAtI'))
    ...
    MULTI_CLIENT = False
    FLOG_CHANNEL = int(env.get("FLOG_CHANNEL", "-1002040564082"))   # Logs channel for file logs
    ULOG_CHANNEL = int(env.get("ULOG_CHANNEL", "-1002040564082"))   # Logs channel for user logs
...
class Server:
    ...
    FQDN = str(env.get("FQDN", "103.248.61.166:9090"))
    URL = "http{}://{}{}/".format(
